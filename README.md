...
Knowledge Base & RAG AI Agent	Automatically ingests documents from Google Drive into a vector database, then answers questions about them through an AI chat agent.	n8n, Google Drive, OpenAI, Pinecone
...
Open the project folder and copy the contents of `workflow.json`.
In n8n, paste it onto the canvas with `Ctrl+V` (or use Import from File).
Connect your own credentials: Google Drive, Pinecone, and OpenAI.
